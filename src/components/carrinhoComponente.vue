                ...
                <div class="descricaoCart">
                    ...
                    <div style="width: 250px" class="botoes">
                        <div class="input-group">
                            <!-- botão para diminuir -->
                            <button type="button" class="btn btn-info btn-sm" @click="diminuiQuantidade ()" v-show="habilitaReducaoItens()">
                            ...
                            <input type="text" class="form-control text-center border-info" name="valor" id="valor" v-model="valor">

                            <!-- botão para aumentar -->
                            <button type="button" class="btn btn-info btn-sm" @click="aumentaQuantidade ()">
                            ...
                            <!-- botão para excluir -->
                            <button type="button" class="btn btn-danger btn-sm" @click="teste()">
                        ...
                        <div>
                            ...
                            <span class="text-dark">Total item: {{ pValor * this.valor}}</span>
                        </div>
                    </div>
                </div>
            </div>
